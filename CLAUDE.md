...
**Two indicators so far.** `skip` appears in both and is 12-1's trick at a short horizon: the recent days are where reversal lives, so leaving them out asks for continuation without buying the bounce.
